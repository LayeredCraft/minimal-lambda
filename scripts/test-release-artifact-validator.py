...
def write_package(path: Path, package_id: str = PACKAGE_ID, *, missing_second_core: bool = False) -> None:
    groups = [("net8.0", True), ("net10.0", not missing_second_core)]
