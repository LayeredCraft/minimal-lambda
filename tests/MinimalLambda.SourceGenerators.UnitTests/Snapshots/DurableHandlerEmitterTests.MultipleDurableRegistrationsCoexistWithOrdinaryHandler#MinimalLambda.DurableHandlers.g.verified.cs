...
namespace MinimalLambda.Generated
{
    ...
    file static class GeneratedDurableLambdaInvocationBuilderExtensions
    {
        ...
        {
            var castHandler = Utilities.Cast(handler, global::System.Threading.Tasks.Task<int> (int arg0, global::Amazon.Lambda.DurableExecution.IDurableContext arg1) => throw null!);
            ...
            async Task InvocationDelegate(ILambdaInvocationContext context)
            {
                ...
                var envelope = context.Serializer.Deserialize<DurableExecutionInvocationInput>(
                    invocationData.EventStream);
                var output = await DurableFunction.WrapAsync<int, int>(
                    (input, durableContext) =>
                    {
                        var arg0 = input;
                        var arg1 = durableContext;
